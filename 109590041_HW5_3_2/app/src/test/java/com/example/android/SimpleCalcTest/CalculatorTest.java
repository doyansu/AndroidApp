...
public class CalculatorTest {
    ...
    public void powTwoPositive() {
        double resultMul = mCalculator.pow(2d, 6d);
        assertThat(resultMul, is(equalTo(64d)));
    }
    ...
    public void powSecondNegative() {
        double resultMul = mCalculator.pow(2d, -6d);
        assertThat(resultMul, is(closeTo(0.015625, 0.001)));
    }

    @Test
    public void powFirstZeroSecondPositive() {
        double resultMul = mCalculator.pow(0d, 6d);
        assertThat(resultMul, is(equalTo(0d)));
    }

    @Test
    public void powSecondZero() {
        double resultMul = mCalculator.pow(8d, 0d);

                ...
                (new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged
                        ...
                        if (isChecked) {
                            ...
                            Calendar nextEleven = Calendar.getInstance();
                            /*if(rightNow.get(Calendar.HOUR_OF_DAY) > 11 || (rightNow.get(Calendar.HOUR_OF_DAY) == 11 && rightNow.get(Calendar.MINUTE) > 11))
                                rightNow.add(Calendar.DAY_OF_MONTH, 1);*/
                            nextEleven.set(Calendar.HOUR_OF_DAY,11);
                            nextEleven.set(Calendar.MINUTE,11);
                            nextEleven.set(Calendar.SECOND,0);
                            long triggerTime = nextEleven.getTimeInMillis();

...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner.setOnItemSelectedListener(spnOnItemSelected);
    ...
    private AdapterView.OnItemSelectedListener spnOnItemSelected
        ...
        public void onItemSelected(AdapterView<?> parent, View view,
                                   int pos, long id) {
            //mTitleText.setText((String)parent.getSelectedItem());
            HTTP = (String)parent.getSelectedItem();
    ...
    public void getSourceCode(View view) {
        ...
        String queryString = HTTP + mBookInput.getText().toString();
